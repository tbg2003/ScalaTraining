...
// 1 : False because the binary/ hex value of S is different to s, same for R & r, T & t, ...
val q1: Boolean = "STRING" == "string"

// 2 : No as they are of different types, cannot convert from integer to string
val x1: Int = 1
...
val `new`: String = "backticks make life easier"
